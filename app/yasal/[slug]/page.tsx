...
const LEGAL_PAGES: Record<string, { title: string; icon: string; sections: { heading: string; text: string }[] }> = {
  ...
  'mesafeli-satis': {
    ...
    icon: 'FileText',
    sections: [
      { heading: '1. Bu Sayfanın Amacı ve Kapsamı', text: 'İşbu sayfa, Mezathane.tr platformunda müzayede düzenleyen satıcıların, alıcılarıyla aralarındaki satışlarda uygulayacakları Mesafeli Satış Sözleşmesi\'nde uymaları gereken asgari standardı ve platformun bu konudaki denetim yükümlülüğünü düzenler.\n\n⚠️ Bu sayfa, alıcı ile satıcı arasındaki BAĞLAYICI satış sözleşmesi DEĞİLDİR. Her satıcının kendi profil sayfasında yayınladığı, kendi Mesafeli Satış Sözleşmesi asıl bağlayıcı belgedir; bir müzayedeye teklif vermeden önce ilgili satıcının "Satış Şartları" sayfasını okumanız gerekir.' },
      { heading: '2. Platformun Rolü', text: 'Mezathane.tr, 6563 sayılı Elektronik Ticaretin Düzenlenmesi Hakkında Kanun kapsamında ARACI HİZMET SAĞLAYICIDIR. Platform, müzayedeye sunulan ürünlerin satıcısı değildir ve alıcı ile satıcı arasındaki mesafeli satış sözleşmesinin tarafı değildir. Platformun ticari unvanı, adresi ve iletişim bilgileri KVKK Aydınlatma Metni ve Ön Bilgilendirme Formu sayfalarında yer almaktadır.' },
      { heading: '3. Satıcının Yükümlülüğü', text: 'Platformda müzayede düzenleyebilmek için her satıcı, 6502 sayılı Tüketicinin Korunması Hakkında Kanun ve Mesafeli Sözleşmeler Yönetmeliği\'ne uygun kendi Mesafeli Satış Sözleşmesi\'ni hazırlamak ve kendi profil sayfasında yayınlamak zorundadır. Bu belgenin içeriği tamamen satıcıya aittir; platform bu belge için örnek metin veya şablon sağlamaz, içeriğine müdahale etmez.' },
      { heading: '4. Sözleşmede Bulunması Gereken Asgari Unsurlar', text: 'Satıcının kendi Mesafeli Satış Sözleşmesi\'nde en az şu bilgiler bulunmalıdır:\n\n• Satıcının ticari unvanı, adresi, vergi dairesi ve vergi numarası\n• Satılan ürünün temel özellikleri, fiyatı ve ödeme şekli\n• Teslimat süresi ve şekli, kargo/teslimat sorumluluğu\n• Cayma hakkının kapsamı ve istisnaları (müzayede yoluyla satışlarda 6502 sayılı Kanun md. 53/ç gereği cayma hakkı bulunmadığı açıkça belirtilmelidir)\n• Ayıplı/açıklamaya uygun olmayan üründe izlenecek yol ve süre\n• Uyuşmazlık halinde yetkili merci' },
      { heading: '5. Platformun Denetimi', text: 'Platform, satıcı onay sürecinde bu belgenin varlığını ve yukarıdaki asgari unsurları içerip içermediğini kontrol eder; eksik veya mevzuata aykırı bulunan satıcı başvuruları onaylanmaz. Ancak belgenin hukuki yeterliliğinden ve güncelliğinden satıcı sorumludur; platform bir hukuk bürosu değildir ve satıcının belgesini hukuken onaylamış sayılmaz.' },
      { heading: '6. Uyuşmazlık', text: 'Satıcının kendi Mesafeli Satış Sözleşmesi\'nden doğabilecek uyuşmazlıklarda Tüketici Hakem Heyetleri ve Tüketici Mahkemeleri yetkilidir; platform bu uyuşmazlıklarda taraf değildir, talep halinde taraflar arasında arabuluculuk yapabilir.' },
    ],
  },
  'on-bilgilendirme': {
    ...
    icon: 'Info',
    sections: [
      { heading: 'Bu Sayfanın Amacı', text: 'İşbu sayfa, Mezathane.tr platformunda müzayede düzenleyen satıcıların, alıcılarına sözleşme kurulmadan önce sunmaları gereken Ön Bilgilendirme Formu\'nda uymaları gereken asgari standardı ve platformun bu konudaki denetim yükümlülüğünü düzenler.\n\n⚠️ Bu sayfa, alıcıya sunulan BAĞLAYICI Ön Bilgilendirme Formu DEĞİLDİR. Her satıcının kendi profil sayfasında yayınladığı kendi Ön Bilgilendirme Formu, 6502 sayılı Kanun gereğince sözleşme kurulmadan önce alıcının onaylaması gereken asıl belgedir.' },
      { heading: '1. Platformun Rolü', text: 'Mezathane.tr, aracı hizmet sağlayıcı olarak faaliyet göstermektedir; müzayedeye sunulan ürünlerin satıcısı değildir. Platformun kendi ticari unvanı, adresi, vergi bilgileri ve iletişim bilgileri KVKK Aydınlatma Metni sayfasında yer almaktadır.' },
      { heading: '2. Satıcının Yükümlülüğü', text: 'Platformda müzayede düzenleyebilmek için her satıcı, 6502 sayılı Tüketicinin Korunması Hakkında Kanun ve Mesafeli Sözleşmeler Yönetmeliği\'ne uygun kendi Ön Bilgilendirme Formu\'nu hazırlamak ve kendi profil sayfasında yayınlamak zorundadır. Bu belgenin içeriği tamamen satıcıya aittir; platform örnek metin veya şablon sağlamaz.' },
      { heading: '3. Formda Bulunması Gereken Asgari Bilgiler', text: 'Satıcının kendi Ön Bilgilendirme Formu\'nda en az şu bilgiler bulunmalıdır:\n\n• Satıcının ticari unvanı, adresi, vergi dairesi, vergi numarası ve iletişim bilgileri\n• Ürünün temel özellikleri, satış fiyatı ve ödeme şekli\n• Teslimat süresi, şekli ve masrafları\n• Cayma hakkının kapsamı ve istisnaları\n• Sipariş konusu edimin yerine getirilememesi halinde uygulanacak süre ve iade usulü (Mesafeli Sözleşmeler Yönetmeliği md. 16/4)' },
      { heading: '4. Platformun Denetimi', text: 'Platform, satıcı onay sürecinde bu belgenin varlığını ve yukarıdaki asgari unsurları içerip içermediğini kontrol eder; eksik veya mevzuata aykırı bulunan satıcı başvuruları onaylanmaz. Belgenin hukuki yeterliliğinden ve güncelliğinden satıcı sorumludur.' },
    ],
  },
  'iptal-iade': {
    ...
    icon: 'RotateCcw',
    sections: [
      { heading: '1. Bu Sayfanın Amacı', text: 'İşbu sayfa, Mezathane.tr platformunda müzayede düzenleyen satıcıların, alıcılarına sunacakları İptal ve İade Koşulları\'nda uymaları gereken asgari standardı ve platformun bu konudaki denetim yükümlülüğünü düzenler.\n\n⚠️ Bu sayfa, alıcı ile satıcı arasındaki BAĞLAYICI iptal/iade koşulları DEĞİLDİR. Her satıcının kendi profil sayfasında yayınladığı kendi İptal ve İade Koşulları asıl bağlayıcı belgedir.' },
      { heading: '2. Genel Hukuki Çerçeve', text: 'Müzayede yoluyla satışa sunulan ürünler, 6502 sayılı Tüketicinin Korunması Hakkında Kanun\'un 53/ç maddesi ve Mesafeli Sözleşmeler Yönetmeliği gereği "Cayma Hakkının İstisnaları" kapsamındadır; bu nedenle müzayedelerden satın alınan ürünlerde cayma hakkı kullanılamaz. Ancak ürünün açıklamaya uygun olmaması veya ayıplı olması halinde tüketici hakları saklıdır. Her satıcının kendi İptal ve İade Koşulları bu genel çerçeveye aykırı olamaz.' },
      { heading: '3. Satıcının Yükümlülüğü', text: 'Platformda müzayede düzenleyebilmek için her satıcı, yukarıdaki hukuki çerçeveye uygun kendi İptal ve İade Koşulları\'nı hazırlamak ve kendi profil sayfasında yayınlamak zorundadır. Bu belgede en az şunlar bulunmalıdır: ayıplı/açıklamaya uygun olmayan üründe alıcının başvuru yapabileceği süre ve iletişim kanalı, haklı bulunan iade taleplerinde ürün bedelinin kaç gün içinde iade edileceği, hasarlı teslimatta izlenecek yol.' },
      { heading: '4. Platformun Denetimi', text: 'Platform, satıcı onay sürecinde bu belgenin varlığını ve yukarıdaki asgari unsurları içerip içermediğini kontrol eder; eksik veya mevzuata aykırı bulunan satıcı başvuruları onaylanmaz. Belgenin hukuki yeterliliğinden ve güncelliğinden satıcı sorumludur; anlaşmazlık halinde platform taraflar arasında arabuluculuk yapabilir.' },
    ],
  },
  'banka-hesap': {
  ...
  'kullanim-kosullari': {
    ...
    icon: 'Scale',
    sections: [
      { heading: '1. Genel', text: 'Bu Kullanım Koşulları, Mezathane.tr internet sitesi ve mobil uygulamalarının (kısaca "Platform") kullanımına ilişkin genel esasları düzenler. Platformu ziyaret ederek veya kullanarak bu koşulları kabul etmiş sayılırsınız. Üyelik, müzayede, kişisel veri ve çerez konularındaki ayrıntılı kurallar; Üyelik Sözleşmesi, Müzayede Şartnamesi, KVKK Aydınlatma Metni, Gizlilik Politikası ve Çerez Politikası ile birlikte geçerlidir.\n\nMesafeli Satış Sözleşmesi, Ön Bilgilendirme Formu ve İptal/İade Koşulları\'nın alıcıyı bağlayan asıl hali, ilgili satıcının kendi profil sayfasında ("Satış Şartları") yayınladığı belgedir; platformun aynı adlı sayfaları (`/yasal/mesafeli-satis` vb.) satıcıların bu belgeleri hazırlarken uyması gereken asgari standardı gösterir, alıcıyı bağlayan sözleşme değildir. Bir çelişki halinde ilgili özel sözleşme hükümleri esas alınır.' },
