...
const LEGAL_PAGES: Record<string, { title: string; icon: string; sections: { heading: string; text: string }[] }> = {
  ...
  'uyelik-sozlesmesi': {
    ...
    sections: [
      ...
      { heading: '7. Ödeme ve Teslimat', text: 'Müzayedede verilen pey (teklif) tutarı, eserin KDV dahil satış bedelidir. Müzayedeyi kazanan alıcı, satış bedeline ek olarak satış bedelinin %10\'u oranında hizmet bedeli ile bu bedelin KDV\'sini öder. KDV oranı lot bazında değişkenlik gösterir (%1, %10 veya %20). Ödenecek toplam tutar, teklif verme ekranında açıkça gösterilir. Örnek: %20 KDV uygulanan bir lotta 20.000 TL kazanan teklif için toplam ödeme 22.400 TL\'dir (20.000 + 2.000 hizmet bedeli + 400 KDV). Satıcıdan alınan hizmet komisyonu, satıcı onay sürecinde platform ile satıcı arasında belirlenen oran üzerinden satış bedelinden kesilir.\n\n• Ödeme, müzayede bitiminden itibaren belirtilen süre içinde (varsayılan 7 gün; müzayede bazında 2-7 gün arasında değişebilir) gerçekleştirilmelidir.\n• Satın alınan eserler için fatura, üye numarasına, ad, soyad ve adrese göre düzenlenmektedir.\n• Teslimat koşulları satıcı tarafından belirlenecek olup, detaylar sipariş onayı sonrası paylaşılacaktır.\n• Kargo firmasından kaynaklanan gecikmelerden Platform sorumlu tutulamaz.' },
  ...
  'banka-hesap': {
    ...
    sections: [
      ...
      { heading: 'Ödeme Süresi', text: 'Müzayedeyi kazandıktan sonra ödemenizi, müzayede detayında belirtilen süre içinde (varsayılan 7 gün; müzayede bazında 2-7 gün arasında değişebilir) tamamlamanız gerekmektedir. Süresinde yapılmayan ödemeler için cezai işlem uygulanabilir ve hesabınız kısıtlanabilir.' },
  ...
  'kullanim-kosullari': {
    ...
    icon: 'Scale',
    sections: [
      { heading: 'Genel', text: 'Mezathane.tr platformunun kullanım koşulları ve hizmet şartları Üyelik Sözleşmesi ve Müzayede Şartnamesi kapsamında düzenlenmektedir. Detaylı bilgi için ilgili sözleşmeleri inceleyiniz.' },
    ],
  },
};
