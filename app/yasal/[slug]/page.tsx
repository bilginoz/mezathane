...
const LEGAL_PAGES: Record<string, { title: string; icon: string; sections: { heading: string; text: string }[] }> = {
  'kvkk': {
    ...
    icon: 'Shield',
    sections: [
      { heading: '1. Veri Sorumlusu', text: 'MANES YAPI İNŞAAT SANAYİ TİCARET LİMİTED ŞİRKETİ, Kemeraltı Mah. 155 Sk. Yaşam 1322 No: 38 İç Kapı No: 8 Marmaris/Muğla, Marmaris Vergi Dairesi, Vergi No: 6121803775 (bundan böyle "Platform"), 6698 sayılı Kişisel Verilerin Korunması Kanunu ("KVKK") kapsamında veri sorumlusu sıfatıyla kişisel verilerinizi aşağıda açıklanan amaçlar doğrultusunda işlemektedir.' },
  ...
  'uyelik-sozlesmesi': {
    ...
    icon: 'BookOpen',
    sections: [
      { heading: '1. Taraflar', text: 'İşbu Üyelik Sözleşmesi, MANES YAPI İNŞAAT SANAYİ TİCARET LİMİTED ŞİRKETİ, Kemeraltı Mah. 155 Sk. Yaşam 1322 No: 38 İç Kapı No: 8 Marmaris/Muğla, Marmaris Vergi Dairesi, Vergi No: 6121803775 (bundan böyle "Platform") ile platforma üye olan gerçek veya tüzel kişi ("Üye") arasında, üyelik işleminin tamamlanması ile birlikte yürürlüğe girer.' },
