...
async function main() {
  ...
  const categoriesData = [
    ...
    { name: 'Hat & Tezhip', slug: 'hat-tezhip', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9d/Hilye-i_Saadet_by_Mustafa_Rakim.jpg/960px-Hilye-i_Saadet_by_Mustafa_Rakim.jpg', sortOrder: 7 },
    { name: 'Efemera', slug: 'efemera', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Constantinople_Purger_2802.jpg/960px-Constantinople_Purger_2802.jpg', sortOrder: 8 },
    ...
    { name: 'Tesbih', slug: 'tesbih', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/Ottoman_Faturan_Prayer_Bead.JPG/960px-Ottoman_Faturan_Prayer_Bead.JPG', sortOrder: 10 },
